              ...
              Rectangle {
                  ...
                  RowLayout {
                      ...
                      Item {
                          ...
                          Rectangle {
                              anchors.fill: parent; radius: 6; color: Colors.bgAlt
                              visible: ico.status !== Image.Ready
                              Text {
                                  anchors.centerIn: parent
                                  text: (card.modelData.appName || "?").charAt(0).toUpperCase()
                                  color: Colors.fg; font.pixelSize: 14; font.weight: Font.Bold
                              }
                          }
                      }
                      ...
                      ColumnLayout {
                          ...
                          RowLayout {
                              ...
                              Text {
                                  ...
                                  color: Colors.fgAlt; font.family: "Fira Sans"; font.pixelSize: 12
                                  Layout.fillWidth: true; elide: Text.ElideRight
                              }
                              Text {
                                  text: "✕"; color: Colors.base03; font.pixelSize: 13
                                  MouseArea {
                          ...
                          Text {
                              ...
                              color: Colors.fgAlt; font.family: "Fira Sans"; font.pixelSize: 13
                              Layout.fillWidth: true; wrapMode: Text.WordWrap
                              maximumLineCount: 2; elide: Text.ElideRight
                              textFormat: Text.PlainText
                          }
